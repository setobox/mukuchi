...
#footer
[查看 Meta 配置](/posts/markdown/_getting-started)
::
```
...
当前文章字段见[文章 Meta 示例](/posts/markdown/_getting-started)。如果要查询新的自定义字段，还需要扩展内容集合的 schema 和校验规则。数据绑定不等于在 Markdown 中编写完整 Vue 模板；业务逻辑应放在组件中。
