...
const filename = resolve(process.env.NUXT_ADMIN_DATABASE_PATH || '.data/admin.sqlite')
const directory = fileURLToPath(new URL('../migrations/admin/', import.meta.url))
