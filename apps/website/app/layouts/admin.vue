...
const navigation = [{ to: '/admin', label: '文章', icon: 'i-lucide-files' }, { to: '/admin/stats', label: '访问统计', icon: 'i-lucide-chart-no-axes-combined' }, { to: '/admin/publications', label: '发布记录', icon: 'i-lucide-history' }]
